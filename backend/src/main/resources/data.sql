...
INSERT INTO tb_course (name,img_Uri,img_Gray_Uri) VALUES ('Bootcamp HTML', 'teste','teste');


INSERT INTO tb_offer (edition, start_Moment, end_Moment, course_id) VALUES ('1.0', TIMESTAMP WITH TIME ZONE '2020-11-20T03:00:00Z', TIMESTAMP WITH TIME ZONE '2021-11-20T03:00:00Z', 1);
INSERT INTO tb_offer (edition, start_Moment, end_Moment, course_id) VALUES ('2.0', TIMESTAMP WITH TIME ZONE '2020-12-20T03:00:00Z', TIMESTAMP WITH TIME ZONE '2021-12-20T03:00:00Z', 1);

INSERT INTO tb_notification (text, moment, read, route, user_id) VALUES ('Parabéns', TIMESTAMP WITH TIME ZONE '2020-12-20T03:00:00Z' , TRUE ,'teste', 1);

INSERT INTO tb_resource (title, description, position, img_uri, type, offer_id) VALUES ('Trilha HTML','Trilha principal do curso',1,'teste',1,1);
...
INSERT INTO tb_content (id, text_content, video_uri) VALUES (1,'material de apoio', 'teste');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('aula 2 do capitulo 1' , 2 ,1);
INSERT INTO tb_content (id, text_content, video_uri) VALUES (2,'', 'teste');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('aula 3 do capitulo 1' , 3 ,1);
INSERT INTO tb_content (id, text_content, video_uri) VALUES (3,'', 'teste');

INSERT INTO tb_lesson (title, position, section_id) VALUES ('tarefa do cap 1' , 4 ,1);
INSERT INTO tb_task (id, description,question_count,approval_count,weight, due_date) VALUES (4,'fazer tarefa', 5,4,1.0,TIMESTAMP WITH TIME ZONE '2020-11-25T13:00:00Z');
